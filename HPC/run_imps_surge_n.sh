...
### gen_seeds $3 $4
mkdir seeds_surge_n15_pi0
mkdir results_surge_n15_pi0
python3 gen_seeds.py n15 0 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 0

mkdir seeds_surge_n15_pi1
mkdir results_surge_n15_pi1
python3 gen_seeds.py n15 1 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 1

mkdir seeds_surge_n15_pi2
mkdir results_surge_n15_pi2
python3 gen_seeds.py n15 2 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 2

mkdir seeds_surge_n15_pi4
mkdir results_surge_n15_pi4
python3 gen_seeds.py n15 4 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 4

mkdir seeds_surge_n15_pi6
mkdir results_surge_n15_pi6
python3 gen_seeds.py n15 6 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 6


mkdir seeds_surge_n15_pi8
mkdir results_surge_n15_pi8
python3 gen_seeds.py n15 8 $1
sbatch monteCarlo.slurm $n_simulations $2 n15 8
