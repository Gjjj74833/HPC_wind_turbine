...
def get_median_long_component(T_s1, T_F, v_bar, white_noise):
    ...
    v_bar : float
        Mean wind speed
    sampling_sourse: np.array
        selected configuration for important sampling
    sampling_noise : np.array
        Random phase added to sampling sourse for important sampling, should be normal 
        distribution with standard deviation of epsilon
